...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Oversaw several Office 365 to Google Workspace projects consisting of over 100,000 users. Made several recommendations that reduced the mean time to project completion by 2 weeks}
        \resumeItem{Lead a team of several Workspace subject matter experts, overseeing the creation of Workspace on boarding materials and training curriculum reducing the time needed to onboard new team members by 3 week.}
        ...
        \resumeItem{Led cost optimization workshops resulting in approximately \$8 million in savings per month, by providing architecture recommendations and cost saving measures}
        \resumeItem{Guided a large media customer through the launch of a Generative AI search tool to 2 million users by providing guidance on architecture best practices, and advising on project timelines \& recommending KPIs}
        \resumeItem{Analyze customer consumption data to develop targeted training plans that boost new project consumption by approximately 30\%}
      \resumeItemListEnd
